...
DATABASE_URL = config("DATABASE_URL", default="postgresql://analytics_user:analytics_pass@clickly_analytics_db:5432/analytics_db")
...
URL_SERVICE_URL = config("URL_SERVICE_URL", default="http://clickly_url_service:8001")
